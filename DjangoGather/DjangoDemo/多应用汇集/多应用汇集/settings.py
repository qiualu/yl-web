"""
Django settings for 多应用汇集 project.
...
WSGI_APPLICATION = '多应用汇集.wsgi.application'
...
# 创建日志文件夹路径
LOG_DIR = os.path.join(BASE_DIR, '文件归纳/日志')
# 确保日志文件夹存在，如果不存在则创建
