"""
Django settings for 福平台案例 project.
...
SECRET_KEY = 'django-insecure-g6d$$ldhdo)k7h6#7(ce8ya)%n1-^jqtko+cb#orl*7mic0y_d'
...
WSGI_APPLICATION = '福平台案例.wsgi.application'
...
AUTH_USER_MODEL = '系统接口.用户'
# AUTH_USER_MODEL = '系统接口.Users'
